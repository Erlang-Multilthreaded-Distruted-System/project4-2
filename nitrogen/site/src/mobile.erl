...
body() ->
    [
        "If you can see this, then your Nitrogen installation is working  123.",
        #p{},
        ...
        #mobile_list{
            ...
            style="display:none",
            body=[
                #mobile_list_divider{class=c, text="Sample Mobile Menu 123"},
                mobile_list_link("Non-mobile Sample Page","/"),
                mobile_list_link("Nitrogen Home","http://nitrogenproject.co m"),
